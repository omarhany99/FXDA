...
const OrderScreen = () => {
  ...
  const [deliverOrder, { isLoading: loadingDeliver }] =
    useDeliverOrderMutation();
  const [pd, { isLoading: loadingpd }] = usePdMutation();
        ...
        <Col md={8}>
          <ListGroup variant="flush">
            ...
            <ListGroup.Item>
              ...
              {order.ispd ? (
                <Message variant="success">Paid on {order.pdAt}</Message>
              ) : (
                <Message variant="danger">Not Paid</Message>
              )}
            </ListGroup.Item>
                ...
                <ListGroup.Item>
                  ...
                  {isPending ? (
                    ...
                    <div>
                      ...
                      <button className="buttondel" onClick={pdHandler}>
                        PAY ON DELIVERD
                      </button>
